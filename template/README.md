...
[Frontier](https://github.com/axia-tech/frontier/tree/master/template) project repository, and can
be used to generate a stand-alone template for use in an independent project via the included
[template generation script](https://github.com/axia-tech/frontier/blob/master/docs/node-template-release.md).

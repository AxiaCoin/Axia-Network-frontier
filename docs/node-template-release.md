...
> [Subtrate node template release process](https://github.com/axia-tech/axlib/blob/master/docs/node-template-release.md) -
...
2.  This release process has to be run in a github checkout Frontier directory with your work
    committed into `https://github.com/axia-tech/frontier/`, because the build script will check
